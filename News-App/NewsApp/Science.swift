...
class Science: UITableViewController{
    ...
    @objc func refresh(sender:AnyObject) {
        ...
        queue.sync{
            let url = self.rootUrl + "/headlines/science"
    ...
    func getSectionNews(){
        ...
        let url = rootUrl + "/headlines/science"
        Alamofire.request(url).responseJSON {
            response in
            self.news = [News]()
            switch response.result {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellScience", for: indexPath) as! ScienceTableViewCell
...
extension Science:  IndicatorInfoProvider {
