...
class Sports: UITableViewController{
...
//        print("refreshing")
        ...
        queue.sync{
            let url = self.rootUrl + "/headlines/sport"
...
//        print("in getSectionNews function")
        ...
        let url = rootUrl + "/headlines/sport"
        Alamofire.request(url).responseJSON {
            response in
            self.news = [News]()
            switch response.result {
...
//        print("in Sports prepare")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellSports", for: indexPath) as! SportsTableViewCell
...
extension Sports:  IndicatorInfoProvider {
