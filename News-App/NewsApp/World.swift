...
class World: UITableViewController{
    ...
    @objc func refresh(sender:AnyObject) {
        ...
        queue.sync{
            let url = self.rootUrl + "/headlines/world"
    ...
    func getSectionNews(){
        ...
        let url = rootUrl + "/headlines/world"
        Alamofire.request(url).responseJSON {
            response in
            self.news = [News]()
            switch response.result {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        //        print("print news in world:",self.news)
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellWorld", for: indexPath) as! WorldTableViewCell
...
extension World:  IndicatorInfoProvider {
