...
class Technology: UITableViewController{
...
//        print("refreshing")
        ...
        queue.sync{
            let url = self.rootUrl + "/headlines/technology"
...
//        print("in getSectionNews function")
        ...
        let url = rootUrl + "/headlines/technology"
        Alamofire.request(url).responseJSON {
            response in
            self.news = [News]()
            switch response.result {
...
//        print("in Technology prepare")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellTechnology", for: indexPath) as! TechnologyTableViewCell
...
extension Technology:  IndicatorInfoProvider {
